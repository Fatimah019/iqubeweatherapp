...
export const fetchWeather = () =>
    apiCallBegan({
        url: `http://api.weatherstack.com/current?access_key=${process.env.REACT_APP_API_KEY}`,
        method: 'GET',
...
export const searchWeatherByLocation = ({ query }: ParamsProps) =>
    apiCallBegan({
        url: `http://api.weatherstack.com/current?access_key=${process.env.REACT_APP_API_KEY}=${query}`,
        method: 'GET',
        onSuccess: fetchWeatherSuccess.type,
        onStart: fetchWeatherStart.type,
        onError: fetchWeatherFailed.type,
